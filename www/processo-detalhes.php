...
<head>
    ...
    <meta charset="UTF-8">
    <title>Processo detalhes - AS Jurídico</title>
...
<body is="dmx-app" id="clientes">
    ...
    <dmx-value id="filtro" dmx-bind:value="'clientes'"></dmx-value>
    <dmx-serverconnect id="sc_captura_slug" url="dmxConnect/api/capturar_slug_processo.php" dmx-param:slug="browser1.location.pathparts.last(1)"></dmx-serverconnect>
        ...
        <div class="row g-0">
            ...
            <nav class="col-auto d-md-block sidebar">
                ...
                <div class="d-flex flex-column justify-content-between navbar-itens">
                    <ul class="nav flex-column w-100 h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-active" dmx-on:click="run({run:{outputType:'text',action:`browser1.goto('/processos')`}})" href="/processos">
            ...
            <main class="col main-content">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="mb-0 text-secondary">Título:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].processo}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="text-secondary mb-0">Descrição:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].descricao}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].status}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="mb-0 text-secondary">Data de distribuição:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].data_distribuicao}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="text-secondary mb-0">Data de conclusão:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].data_conclusao}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="mb-0 text-secondary">Último andamento:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].ultimo_andamento}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="text-secondary mb-0">Penúltimo andamento:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].penultimo_andamento}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="mb-0 text-secondary">Órgão:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].justica}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="text-secondary mb-0">Comarca:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].comarca}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="text-secondary mb-0">Vara:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].vara || "-"}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="mb-0 text-secondary">Tese:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].tese}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="text-secondary mb-0">Autor:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].autor}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="text-secondary mb-0">Réu:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].reu}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="mb-0 text-secondary">Link:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].url}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="mb-0 text-secondary">Cadastrado em:</p>
                                                <p class="mb-0">{{sc_captura_slug.data.query[0].criado_em}}</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                ...
                <div class="table-container animate-fade-in card-detalhes" style="animation-delay: 0.5s">
                    <div class="d-flex align-items-center w-100 flex-column justify-content-start" dmx-show="filtro.value=='clientes'" id="clientes">
                        <div class="d-flex w-100">
                            <p class="text-start">Clientes vinculados</p>
                        </div>
                        <div class="table-responsive w-100">
                            <table class="table">
                                ...
                                <tbody is="dmx-repeat" id="repeat1" dmx-bind:repeat="sc_clientes.data.query" key="id">
                                    <tr dmx-on:click="browser1.goto('/clientes/'+slug)" dmx-style:cursor="'pointer'">
                                        <td>{{id}}</td>
                                        <td>{{nome}}</td>
                                        <td>{{celular}}</td>
                                        <td>{{tipo}}</td>
